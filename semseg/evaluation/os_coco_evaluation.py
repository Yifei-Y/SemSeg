...
from semseg.data.graspnet_meta import GRASPNET_KNOWN_CATEGORIES, GRASPNET_KNOWN_IDS
from semseg.data.custom import COCO_INVOC_CATEGORIES, COCO_INVOC_IDS
...
class OpensetCOCOEvaluator(DatasetEvaluator):
    ...
    See http://cocodataset.org/#detection-eval to understand its metrics.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            eval_type (str): evaluation type, currently support ["openset"]
        ...
        if "graspnet" in dataset_name:
            ...
            self.known_names = COCO_INVOC_CATEGORIES
            self.known_ids = COCO_INVOC_IDS
    ...
    def evaluate(self, img_ids=None, resume=False):
        ...
        Args:
            ...
            resume: whether use existed instances_predictions.pth or regenerate instances_predictions.pth
        """
        if not resume:
    ...
    def _derive_coco_results(self, coco_eval, iou_type, eval_type, class_names=None):
        ...
        if eval_type == "openset":
            ...
            results['AOSE'] = coco_eval.stats[14]
